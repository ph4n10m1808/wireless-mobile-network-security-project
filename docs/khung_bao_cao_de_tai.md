...
| :---------------------------------------- | :-------------------------: | :----------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Giả lập mạng vô tuyến ảo** |          8 Radios          |        **32 Radios (Hoàn thành)**        | Nâng cấp radios lên 32 giúp tách biệt dải interface của Mininet-WiFi (`wlan1`-`wlan24`) và Host Kali (`wlan30`-`wlan31`), tránh tuyệt đối lỗi tranh chấp namespace gây treo đơ hệ thống.                                                                             |
...
| **Giao diện Kibana SIEM**          |      Chưa cấu hình      |     **Hoàn thành Dashboard**     | Đã tạo Data View `wids-alerts-*` và thiết kế đầy đủ 5 Widget Dashboard Kibana (Metric Count, Bar Chart, Pie Chart, Active Response Chart, Data Table) theo mô tả ở Chương 5. |
